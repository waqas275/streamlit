...
heatmapchart = px.imshow(heatmap,height=1400,width=1200,title="Product & States Heatmap",color_continuous_scale="orange",range_color="orange",labels=dict(color="Revenue"))	
